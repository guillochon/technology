...
public:
  ...
  static constexpr double hunger_threshold = 0.5;
  static constexpr double birth_energy = 2 * mate_energy;
  ...
  static constexpr double terminal_speed = 2;
  ...
  double terminal_speed_value() const;
